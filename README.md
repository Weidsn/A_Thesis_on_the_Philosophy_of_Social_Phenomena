...
Why not develop a comprehensive linguistic framework that does not make any unnecessary social assumptions, much like the framework of mathematics, which any user can adapt and use for their own purpose? On the basis of this framework, philosophical discussions can preceed without having to embark on a mini-project of tedious disambiguation. This is where my MR-N framework comes in. 
